#!/usr/bin/env python3
"""
Redis Integration Example for Agent Spy

This example demonstrates the Redis integration features including:
- Optional Redis with graceful fallbacks
- Caching with Redis and in-memory alternatives
- Session management
- Rate limiting
- Cache management

Run this example to see how the Redis integration works.
"""
...
async def main():
    ...
    print("Agent Spy Redis Integration Demo")
    print("=" * 50)
