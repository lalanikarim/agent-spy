...
class Settings(BaseSettings):
    ...
    api_title: str = Field(
        default="Agent Spy API", description="API documentation title"
    )
    api_description: str = Field(
        default=(
            "LangSmith-compatible observability layer for AI agents "
    ...
    langsmith_endpoint_base: str = Field(
        default="/api/v1",
        description="Base path for LangSmith-compatible endpoints"
    )
    support_legacy_endpoints: bool = Field(
        default=True,
        description="Support legacy LangChain endpoint formats"
    )
